...
class Lecture extends Component {
    ...
    render() {
        return (
            <div>
                <h1>These are my votes: {this.state.counter}</h1>
...
const Lecture = () => {
    ...
    return (
     <div> 
        ...
        <Button click={addHandler} text="Add one">udygsygyusg</Button>
        <Button click={removeHandler} text="Remove one"></Button>
        <Button click={resetHandler}text ="Reset"></Button>
        </div>
    );
}
